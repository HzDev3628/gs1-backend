-- Canonical baseline migration for the Acme Data Room schema.
...
create table public.shares (
  ...
  check (
    (access_type = 'link' and recipient_email is null) or
    (access_type = 'user' and recipient_email is not null)
  )
);
